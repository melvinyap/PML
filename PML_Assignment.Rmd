...
From the output of the training model, it is observed that the out-of-sample
...
**classe** variables are compared to determine its accuracy. The confusion
matrix and statistics table is generated for further analysis.
